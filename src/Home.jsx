...
function Home() {
    return ( <>
        ...
        <section className="d-flex align-items-center">
            <div className="container-fluid navbar_padding">
                <div className="row ">
                    <div className="col-10  mx-auto">
                        <div className="row ">
                            <div className=" col-md-6 pt-5 pt-lg-0 order-2 order-lg-1 d-flex justify-items-center flex-column">
                                ...
                                <div className="mt-3">
                                    <NavLink to="./facultysignup" className="btn-get-started">Getting Started</NavLink>
                                </div><br />
                                <br />
                                <br />
                                ...
                                <h2 className="my-3 "></h2>
                                <div className="mt-3">
                                    <NavLink to="./studentsignup" className="btn-get-started">Getting Started</NavLink>
                                </div>
                                <br />
                                <br />
                                ...
                                <h2 className="my-3 "></h2>
                                <div className="mt-3">
                                    <NavLink to="./adminsignup" className="btn-get-started">Getting Started</NavLink>
                                </div>
                            </div>
