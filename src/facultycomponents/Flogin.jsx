                            ...
                            <div className="col-10 col-md-10 col-lg-8 col-xl-6 ">
                                <div className="card " >
                                    <div className="card-body p-5">
                                        <h2 className="text-uppercase text-center mb-5">Faculty-Login</h2>
                                        ...
                                        <form >
                                            ...
                                            <p className="text-center text-muted mt-6 mb-0">Do not have an account? <NavLink to="/facultysignup" class="fw-boldtext-danger text-body"><u>SignUp here</u></NavLink></p>
