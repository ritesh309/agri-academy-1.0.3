...
import "../facultycomponents/Fsignup.css"
                            ...
                            <div className="col-12 col-md-9 col-lg-7 col-xl-6">
                                <div className="card" >
                                    <div className="card-body p-5">
                                        ...
                                        <h3 className="text-uppercase text-center mb-5">Faculty-Section</h3>
                                        ...
                                        <form >
                                            ...
                                            <div className="form-check d-flex justify-content-center mb-5">
                                                ...
                                                <label className="form-check-label" for="">
                                                    I agree all statements in <NavLink to="/service" className="text-body"><u>Terms of service</u></NavLink></label>
                                            ...
                                            <p className="text-center text-muted mt-5 mb-0">Have already an account? <NavLink to="/facultylogin" class="fw-bold text-body">Login here</NavLink></p>
